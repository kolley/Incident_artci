            ...
            <header className="absolute inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="bg-white-800 flex items-center justify-between p-6 lg:px-8">
                    ...
                    <div className="hidden lg:flex lg:gap-x-12">
                        <Link href="#" className="px-10 text-lg rounded-full font-semibold text-white hover:bg-white hover:text-orange-600 transition">
                            Accueil
                        </Link>

                        <Link href="https://www.artci.ci/" className="px-10 text-lg rounded-full font-semibold text-white hover:bg-white hover:text-orange-600 transition">
                            A propos
                        </Link>

                        <Link href="/images/DECISI~1_INCIDENT.PDF" className="px-10 text-lg rounded-full font-semibold text-white hover:bg-white hover:text-orange-600 transition">
                            décision
                        </Link>
                    </div>
